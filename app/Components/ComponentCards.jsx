...
const ComponentCards = ({name, image, description,components_no,  url}) => {
  return (
    <Link href={url} className='w-full flex gap-5 divide-x pl-4 divide-secondary  p-2 max-h-24 h-24 rounded-xl items-center hover:border-secondary border-2  border-transparent bg-secondary/50'>

...
import CustomDropDown_2 from "@/app/Preview_components/Dropdowns/CustomDropdown_2";
...
const page = () => {
  ...
  return (
    <>
      ...
      />
      <ComponentPreview
        component_name={DropdownsInfo[2].title}
        component_details={DropdownsInfo[2].details}
        component_usage_code={DropdownsInfo[2].usage_code}
        component_preview={
          <div className="bg-cyan-700/20 text-center space-y-3 p-5 rounded-lg min-w-full md:min-w-40 h-56">
            <span className="text-white">{dropDownValue}</span>
            <CustomDropDown_2
        ...
        component_code={DropdownsInfo[2].code}
        component_packages={DropdownsInfo[2].packages}
      />
    </>
  );
};

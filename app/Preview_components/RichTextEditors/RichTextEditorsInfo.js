const RichTextEditorsInfo = [
  {
    title: "Dev Rich Text Editor",
    details: {
      description:
    ...
    usage_code: `
        import DevRichTextEditor from "@/app/dev_components/DevRichTextEditor";
        import React from "react";
        
        const page = () => {        
          return <DevRichTextEditor />;
        };
        
        export default page;
              `,
    code: `//Create a File DevRichTxtEditor as well as export it and it will work seamlessly
...
const DevRichTextEditor = () => {
  ...
  return (
    <main className="overflow-hidden overflow-y-scroll [&::-webkit-scrollbar]:hidden [scrollbar-width:none] w-full max-w-3xl h-full min-h-60 resize-y bg-slate-50 rounded-xl shadow-md p-2">
      {/* Toolbar section */}
...
export default RichTextEditorsInfo;
